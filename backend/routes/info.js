...
router.post('/save', authenticateToken, async (req, res) => {
    try {
        ...
        if (existingProfile.length > 0) {
            ...
            console.log('🔄 Updating existing profile with student_type');
        } else {
            ...
            console.log('➕ Creating new profile with student_type');
        }
        ...
        console.log('✅ Profile saved successfully with student_type');
